...
void InstallHook(_hook_t * hook)
{
    ...
    PVOID targetFunc = (PVOID)GetProcAddress(GetModuleHandle(hook->libraryName), hook->funcName);
...
#define MAX_INSTRUCTIONS 32
    ...
    *hook->old_func = (void*)trampAddr;
    ...
    unsigned __int64 myFuncInt = (unsigned __int64)hook->new_func;
...
#define MAX_INSTRUCTIONS 32
    ...
    *hook->old_func = (void*)trampAddr;
    ...
    //intercept target function, send all calls to my function
    DWORD myFuncPtr = (DWORD)hook->new_func;
